...
import DisplayReturns from '../ReturnsCalculator/DisplayReturns';
const FundDetails = () => {
    ...
    return (
        <div >
            <nav className="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                        <a href="/result" className="flex items-center bg-blue-800 text-white px-2 py-1 rounded hover:bg-blue-600 transition duration-300">
                            <svg
            ...
            <div className="container mx-auto px-4 py-8 mt-12">
                ...
                {/* Display component for the returns calculator */}
                <div className="mt-8">
                    <DisplayReturns />
                </div>
            </div>
